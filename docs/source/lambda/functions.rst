Overview of Data Transformation Tasks
=====================================

Functionality of Data Transformation Tasks
------------------------------------------

The following fleet of ECS data transformation tasks will be responsible for end-to-end flow for the Cypienta Correlation Pipeline.
...
#. **skip_batch:**
    ...
    - This task will be triggered by in the ``skip_batch`` DAG.
    ...
    - If there are, then it will prepare the input data for the sequencer model and trigger the ``start_sequencer`` task.
